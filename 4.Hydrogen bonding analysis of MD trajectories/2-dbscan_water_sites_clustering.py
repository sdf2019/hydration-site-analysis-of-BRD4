...
# Parameter settings
# ========================
INPUT_CSV = "hbond-network/4o70_water_filtered.csv"
BASE_OUTPUT_DIR = "watersite/4o70"

EPS_START = 0.3
EPS_END = 0.9
EPS_STEP = 0.1         # change the step size here

MIN_SAMPLES = 250        # Minimum number of occurrences
...
for EPS in eps_values:
    ...
    # ------------------------
    # Statistics for each water site
    # ------------------------
    site_records = []
    site_id_map = {}
    ...
    for label in sorted(set(labels)):
        ...
        count = len(site_df)
        n_structures = site_df["frame"].nunique()
